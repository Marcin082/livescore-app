...
const Leagues = ({ dateformat }) => {
  ...
  const UefaLogo =
    "https://i.pinimg.com/originals/ae/8b/9c/ae8b9c772901208d18c752f356574dc7.png";
  ...
  return (
    <>
      <LeagueNav>
        ...
        <League onClick={() => FilterByLeague("152", dateformat)}>
          <LeagueLogo src={SearchLogo("152")} />
          Premier League
        </League>
        <League onClick={() => FilterByLeague("302", dateformat)}>
          <LeagueLogo src={SearchLogo("302")} />
          La Liga
        </League>
        <League onClick={() => FilterByLeague("207", dateformat)}>
          <LeagueLogo src={SearchLogo("207")} />
          Serie A
        </League>
        <League onClick={() => FilterByLeague("175", dateformat)}>
          <LeagueLogo src={SearchLogo("175")} />
          Bundesliga
        </League>
        <League onClick={() => FilterByLeague("168", dateformat)}>
          <LeagueLogo src={SearchLogo("168")} />
          League 1
        </League>
        <League onClick={() => FilterByLeague("3", dateformat)}>
          <LeagueLogo src={EurLogo} />
          Champions League
        </League>
        <League onClick={() => FilterByLeague("4", dateformat)}>
          <LeagueLogo src={EurLogo} />
          Europa League
        </League>
        <League onClick={() => FilterByLeague("683", dateformat)}>
          <LeagueLogo src={EurLogo} />
          Conference League
        </League>
        <League onClick={() => FilterByLeague("633", dateformat)}>
          <LeagueLogo src={UefaLogo} />
          Nations League
        </League>
