...
import {LeagueLink, MatchListContainer,LeagueDetails,CountryLogo,RightArrow, MatchesContainer } from './MatchList.styled';
    ...
    return (
            <>
                {leagueMatches.map((match)=>{
                    return <Match  activeOption={activeOption}  key={match.match_id} match={match} leagueMatches={leagueMatches}/>
                })}
           </>
    );
};
