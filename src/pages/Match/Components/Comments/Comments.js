...
import { CommentsContainer,Comment,Alert ,CommentCard,Time,Player} from './Comments.styled';
                ...
                return(
                    <>
                        <CommentCard>
                            ...
                            <Comment>{comment.text} {comment.state?<Player>({comment.state})</Player>:""}</Comment>
                        </CommentCard>
                </>)
            })}</>:
