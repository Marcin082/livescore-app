        ...
        {actions &&
          actions.map((action) => {
            if (action) {
              ...
              const assist =
                action.what === "goal"
                  ? Object.values(action)[3]
                    ? Object.values(action)[3]
                    : Object.values(action)[8]
                  : "";
              const sub = () => {
                const string =
                  action.what === "sub" ? Object.values(action)[1] : "";
              ...
              sub();
              const scorer = Object.values(action)[1]
                ? Object.values(action)[1]
                : Object.values(action)[6];
              const faulter = Object.values(action)[1]
                ? Object.values(action)[1]
                : Object.values(action)[3];
                ...
                <Action where={action.where}>
                  {action.what === "goal" &&
                    (action.info === "Penalty" ? (
                      ...
                      <Ball src="https://i.pinimg.com/originals/bd/6b/49/bd6b49482d53bbc4e770c8adec28344e.png" />
                    ))}
