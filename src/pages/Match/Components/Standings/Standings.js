...
import { StandingsContiner,Promotion,Square,Legend,Option,ClubCard,Position ,Name,Logo,Nav,Info,Details,Goals,Value} from './Standings.styled';
import useMatches from '../../../../Hooks/UseMatches'
import {Alert} from '../../Components/Comments/Comments.styled'
import { LeagueDetails,CountryLogo,RightArrow} from '../../../Matches/Components/Matchlist/MatchList.styled';
...
const Standings = () => {
    ...
    let i=-1;
    let j=0;
    const colors = ['#121bc9','lightblue','#c9740c','#257d19','#cd5c5c','red']
    ...
    return (
        <StandingsContiner> 
          ...
          <LeagueDetails>
                <section>
                <div>
                        <CountryLogo src={country[0].country_logo?country[0].country_logo:""}/>
                    </div>
                    <div>
        ...
        <>
            ...
            {standings.map((club)=>{
                let { overall_promotion: promotion,team_badge: logo,team_name:name,
                    overall_league_payed:matchesPlayed,overall_league_W:leagueWins,
                    overall_league_L:leagueLost,overall_league_GF: goalsScored,
                    overall_league_GA:goalsLost,overall_league_PTS:leaguePoints,
                    league_id:leagueId,team_id:Id } = club;
                ...
                return(
                    ...
                    <ClubCard>
                        <Info>
                            <Position  
                            color={promotion===""?"transparent":colors[j]}>{club.overall_league_position}
                            </Position>
                            <Logo src={logo}/>
                            <Name><Link onClick={()=> getStandings(leagueId)} to={"/team/"+ Id} style={{
                    textDecoration:'none',
                    color: 'inherit'
                }}>{name}</Link></Name>
                        </Info>
