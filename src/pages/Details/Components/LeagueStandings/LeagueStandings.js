...
import { StandingsContiner,Promotion,Square,Legend,Option,ClubCard,Position ,Name,Logo,Nav,Info,Details,Goals,Value} from '../../../Match/Components/Standings/Standings.styled';
        ...
        <StandingsContiner> 
            ...
            {standings.map((club)=>{
                let { overall_promotion: promotion,team_badge: logo,team_name:name,
                    ...
                    overall_league_position:position,league_id:leagueId,team_id:Id } = club;
                ...
                return(
                    ...
                    <ClubCard>
                        <Info>
                            <Position  
                            color={promotion===""?"transparent":colors[j]}>{position}
                            </Position>
                            <Logo src={logo}/>
                            <Link onClick={()=>getStandings(leagueId)} to={"/team/"+ Id} style={{
                    textDecoration:'none',
                    color: 'inherit'
                }}><Name>{name}</Name></Link>
                        </Info>
